...
class Placement(object):
    ...
    def __init__(self):
        ...
        self.COLORS = [
            '#0C0786', '#100787', '#130689', '#15068A', '#18068B', '#1B068C', '#1D068D', '#1F058E', '#21058F',
            ...
            '#7C02A7', '#7E03A7', '#7F03A7', '#8104A7', '#8204A7', '#8405A6', '#920FA2', '#9310A1', '#9511A1',
    ...
    def simulate(self, save_matrix=False, show_pygame=False, access_point=None):
        ...
        if show_pygame:
            ...
            self.print_pygame(matrix_results)
...
if __name__ == '__main__':
    ...
    m  = p.simulate(save_matrix=False, show_pygame=False, access_point=access_point)
