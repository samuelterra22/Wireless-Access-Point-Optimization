...
dwg = ezdxf.readfile("/home/samuel/Desktop/IFMG/9 Periodo/TCC/bloco-A-l.dxf")
...
for e in modelspace:
    if e.dxftype() == 'LINE':
        if e.dxf.layer == 'ARQ':
            ...
            saida_pygame += 'pygame.draw.line(DISPLAYSURF, BLUE, ('+str((e.dxf.start[0]-xMin)*escala)+', '+str((e.dxf.start[1]-yMin)*escala)+'), ('+str((e.dxf.end[0]-xMin)*escala)+', '+str((e.dxf.end[1]-yMin)*escala)+'))\n'
